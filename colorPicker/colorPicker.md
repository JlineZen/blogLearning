...
#### [unselectable属性](https://msdn.microsoft.com/en-us/library/hh801966(v=vs.85).aspx)

官方解释为禁止元素被选择，取值为off与on，分别代表可选择与不可选择。

#### 事件代理的使用

组件库中所有事件都代理绑定在主容器colorpicker上，利用事件的事件冒泡原理；